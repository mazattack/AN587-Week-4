...
```
Height and weight both appear to follow a normal distribution as the shape of the histograms and the qq plots fit nicely with what we would expect to see with a normal distribution, particularly that the majority of the points fall on the qqline shown in the qqplot. Age also appears to match this distribution, which is unusual as age is not usually normally distributed in society. However given that age was calculated as continuous data and the distribution of this sample was impacted by a zombie apocalypse, I will treat age as normally distributed. Years of education and number of zombies killed are count data and therefore likely to be poisson distributions. 
